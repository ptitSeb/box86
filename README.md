...
Here are 5 videos, one of "Airline Tycoon Deluxe" running on a gigahertz OpenPandora, and the next 2 of "Bit.Trip.Runner" and "Neverwinter Night" running on an ODroid XU4, and the last 2 on a Pi4: Shovel Sknight (video from @ITotalJustice) and Freedom Planet (video from @djazz)
