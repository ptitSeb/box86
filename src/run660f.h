    ...
    _6f_0x2F:                      /* COMISD Gx, Ex */
        ...
        } else if(isgreater(opx1->d[0], opx2->d[0])) {
            CLEAR_FLAG(F_ZF); CLEAR_FLAG(F_PF); CLEAR_FLAG(F_CF);
        } else if(isless(opx1->d[0], opx2->d[0])) {
    ...
    _6f_0xA5:                      /* SHLD Ew,Gw,CL */
        ...
        op2->word[0] = shld16(emu, op2->word[0], op1->word[0], tmp8u);
        NEXT;
    ...
    _6f_0xAD:                      /* SHRD Ew,Gw,CL */
        ...
        op2->word[0] = shrd16(emu, op2->word[0], op1->word[0], tmp8u);
        NEXT;
    ...
    _6f_0xC1:                      /* XADD Gw,Ew */ // Xchange and Add
        nextop = F8;
        GET_GWEW;
        tmp16u = add16(emu, op2->word[0], op1->word[0]);
        op1->word[0] = op2->word[0];
        op2->word[0] = tmp16u;
        NEXT;
    ...
    _6f_0xC4:  /* PINSRW Gx,Ew,Ib */
        ...
        GET_GXEW;
        tmp8u = F8;
        opx1->uw[tmp8u&7] = op2->word[0];
        NEXT;
    _6f_0xC5:  /* PEXTRW Gw,Ex,Ib */
        nextop = F8;
        GET_GWEX;
        tmp8u = F8;
        op1->dword[0] = opx2->uw[tmp8u&7];
        NEXT;
