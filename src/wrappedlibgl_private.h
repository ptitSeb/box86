...
GO(glXChangeDrawableAttributes,vFi)
GO(glXChangeDrawableAttributesSGIX,vFi)
GO(glXClientInfo,vFv)
GO(glXCopyContext,vFiii)
GO(glXChooseFBConfig, pFpipp)
GO(glXCreateContext,vFiiii)
GO(glXCreateContextWithConfigSGIX,vFiiii)
GO(glXCreateGLXPbufferSGIX,vFii)
GO(glXCreateGLXPixmap,vFiii)
GO(glXCreateGLXPixmapWithConfigSGIX,vFiii)
GO(glXCreateGLXVideoSourceSGIX,vFiiiiii)
GO(glXCreateNewContext,vFiiii)
GO(glXCreatePbuffer,vFii)
GO(glXCreatePixmap,vFiii)
GO(glXCreateWindow,vFiii)
GO(glXDestroyContext,vFi)
GO(glXDestroyGLXPbufferSGIX,vFi)
GO(glXDestroyGLXPixmap,vFi)
GO(glXDestroyGLXVideoSourceSGIX,vFii)
GO(glXDestroyHyperpipeConfigSGIX,iFpi)
GO(glXDestroyPbuffer,vFi)
GO(glXDestroyPixmap,vFi)
GO(glXDestroyWindow,vFi)
GO(glXGetCurrentContext, pFv)
GO(glXGetDrawableAttributes,vFi)
GO(glXGetDrawableAttributesSGIX,vFi)
GO(glXGetFBConfigs,vFv)
GO(glXGetFBConfigsSGIX,vFv)
GO(glXGetVisualConfigs,vFv)
GO(glXGetVisualFromFBConfig, pFpp)
GO(glXHyperpipeAttribSGIX,iFpiiip)
//GO(glXHyperpipeConfigSGIX,iFpii?p)
GO(glXIsDirect,vFii)
GO(glXJoinSwapGroupSGIX,vFii)
GO(glXMakeContextCurrent,vFiii)
GO(glXMakeCurrent,vFii)
GO(glXMakeCurrentReadSGI,vFiii)
GO(glXQueryContext,vFv)
GO(glXQueryContextInfoEXT,vFv)
GO(glXQueryExtension, iFppp)
GO(glXQueryExtensionsString,vFi)
...
GO(glXQueryMaxSwapBarriersSGIX,vFv)
GO(glXQueryServerString,vFii)
GO(glXQueryVersion,vFpp)
GO(glXRender,vFv)
GO(glXRenderLarge,vFv)
GO(glXSwapBuffers,vFi)
GO(glXSwapIntervalSGI,vFv)
GO(glXUseXFont,vFiiii)
