...
GO(glXCreateContext,vFpppp)
GO(glXCreateContextAttribsARB, pFpppip)
GO(glXCreateContextWithConfigSGIX,vFpppp)
GO(glXCreateGLXPbufferSGIX,vFpp)
GO(glXCreateGLXPixmap,vFppp)
...
GO(glXDestroyPbuffer,vFp)
GO(glXDestroyPixmap,vFp)
GO(glXDestroyWindow,vFp)
...
GO(glXSwapIntervalEXT, vFppi)
GO(glXSwapIntervalMESA, iFu)
