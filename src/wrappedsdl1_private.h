...
GO(SDL_RWFromConstMem, pFpi)
GO(SDL_RWFromFP, pFpi)
GO(SDL_RWFromFile, pFpp)
GO(SDL_RWFromMem, pFpi)
GO(SDL_ReadBE16, uFp)
GO(SDL_ReadBE32, uFp)
GO(SDL_ReadBE64, UFp)
GO(SDL_ReadLE16, uFp)
