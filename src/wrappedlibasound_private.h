...
GO(__snd_pcm_hw_params_get_buffer_size, iFpp)
GO(snd_pcm_hw_params_get_buffer_size, iFpp)
GO(__snd_pcm_hw_params_get_buffer_size_max, iFpp)
GO(snd_pcm_hw_params_get_buffer_size_max, iFpp)
GO(__snd_pcm_hw_params_get_buffer_size_min, iFpp)
...
GO(__snd_pcm_hw_params_set_access_first, iFppp)
GO(snd_pcm_hw_params_set_access_first, iFppp)
GO(__snd_pcm_hw_params_set_access_last, iFppp)
