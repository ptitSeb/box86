...
// wrapper x86 -> natives of callbacks
WRAPPER(GInitiallyUnowned, constructor, void*, (int type, uint32_t n_construct_properties, void* construct_properties), 3, type, n_construct_properties, construct_properties);
...
WRAPPER(GInitiallyUnowned, dispatch_properties_changed, void*, (int type, uint32_t n_pspecs, void* pspecs), 3, type, n_pspecs, pspecs);
WRAPPER(GInitiallyUnowned, notify, void*, (int type, void* pspecs), 2, type, pspecs);
...
WRAPPER(GtkEntry2, delete_from_cursor, void, (void* entry, int type, int count), 3, entry, type, count);
