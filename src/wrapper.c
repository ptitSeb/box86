...
typedef void (*vFWW_t)(unsigned short, unsigned short);
...
typedef int32_t (*iFpW_t)(void*, unsigned short);
typedef int32_t (*iFpu_t)(void*, uint32_t);
typedef int32_t (*iFpU_t)(void*, uint64_t);
typedef int32_t (*iFpp_t)(void*, void*);
typedef unsigned char (*CFui_t)(uint32_t, int32_t);
...
typedef int32_t (*iFpuc_t)(void*, uint32_t, char);
...
typedef int32_t (*iFiWii_t)(int32_t, unsigned short, int32_t, int32_t);
...
typedef uint32_t (*uFpccc_t)(void*, char, char, char);
...
typedef uint32_t (*uFpcccc_t)(void*, char, char, char, char);
