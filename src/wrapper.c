...
typedef uint32_t (*uFEpC_t)(x86emu_t*, void*, uint8_t);
...
void uFEpC(x86emu_t *emu, uintptr_t fcn) { uFEpC_t fn = (uFEpC_t)fcn; R_EAX=(uint32_t)fn(emu, *(void**)(R_ESP + 4), *(uint8_t*)(R_ESP + 8)); }
