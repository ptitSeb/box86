...
typedef int32_t (*iFEpui_t)(x86emu_t*, void*, uint32_t, int32_t);
...
void iFEpui(x86emu_t *emu, uintptr_t fcn) { iFEpui_t fn = (iFEpui_t)fcn; R_EAX=fn(emu, *(void**)(R_ESP + 4), *(uint32_t*)(R_ESP + 8), *(int32_t*)(R_ESP + 12)); }
