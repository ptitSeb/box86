...
#define PK(a)   *(uint8_t*)(ip+a)
    ...
    &&_0f_0xD8, &&_0f_0xD9, &&_default, &&_default, &&_0f_0xDC ,&&_0f_0xDD, &&_default, &&_default, //0xD8-0xDF
    &&_default, &&_default, &&_default, &&_default, &&_default ,&&_0f_0xE5, &&_default, &&_default, //0xE0-0xE7
    &&_0f_0xE8, &&_0f_0xE9, &&_default, &&_default, &&_0f_0xEC ,&&_0f_0xED, &&_default, &&_0f_0xEF, //0xE8-0xEF
