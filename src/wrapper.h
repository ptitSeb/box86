...
void iFpppiiu(x86emu_t *emu, uintptr_t fnc);
...
void iFiupuuuu(x86emu_t *emu, uintptr_t fnc);
...
void iFppuippuu(x86emu_t *emu, uintptr_t fnc);
...
void iFppppiiiiuui(x86emu_t *emu, uintptr_t fnc);
