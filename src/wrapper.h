...
void vFpuI(x86emu_t *emu, uintptr_t fnc);
void vFpuC(x86emu_t *emu, uintptr_t fnc);
...
void iFEpuppV(x86emu_t *emu, uintptr_t fnc);
...
void iFEpup0V(x86emu_t *emu, uintptr_t fnc);
...
void iFEpvup0V(x86emu_t *emu, uintptr_t fnc);
