...
static void unwrapper_stream_z(x86emu_t* emu, void* str)
{
    (void)emu;
    z_stream *stream = (z_stream*)str;
...
EXPORT int my_inflateBackInit_(x86emu_t* emu, void* str, int windowBits, void *window, void* version, int size)
{
    wrapper_stream_z(emu, str);
...
EXPORT int my_inflateEnd(x86emu_t* emu, void* str)
{
    wrapper_stream_z(emu, str);
...
// TODO: remove this?
EXPORT int my_deflateEnd(x86emu_t* emu, void* str)
{
    wrapper_stream_z(emu, str);
...
EXPORT int my_inflate(x86emu_t* emu, void* str, int flush)
{
    wrapper_stream_z(emu, str);
