...
GO(gtk_style_context_get_property, vFppiG)
...
GO(gtk_style_context_get_style_property, vFppG)
GO(gtk_style_context_get_style_valist, vFpp)
GO(gtk_style_context_get_valist, vFppp)
...
//GOM(gtk_widget_class_bind_template_callback_full, vFEppB)
