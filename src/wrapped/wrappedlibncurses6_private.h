...
//GOM(use_screen, iFp@p)
GO(use_tioctl, vFi)
GO(use_tioctl_sp, vFpi)
//GOM(use_window, iFp@p)
GO(vid_attr, iFuwp)
GO(vid_attr_sp, iFpuwp)
//GOM(vid_puts, iFuwp@)
//GOM(vid_puts_sp, iFpuwp@)
GO(vidattr, iFu)
GO(vidattr_sp, iFpu)
//GOM(vidputs, iFu@)
//GOM(vidputs_sp, iFpu@)
GO(vline, iFui)
GO(vline_set, iFpi)
GOM(vw_printw, iFEppV)
GO(vw_scanw, iFppV) // TODO: check if OK without aligning
GO2(vwprintw, iFEppV, my_vw_printw)
GO(vwscanw, iFppV) // TODO: check if OK without aligning
GO(wadd_wch, iFpp)
