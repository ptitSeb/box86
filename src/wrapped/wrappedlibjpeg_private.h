...
GO(jpeg_CreateCompress, vFpiu)
GO(jpeg_CreateDecompress, vFpiu)
...
GO(jpeg_finish_compress, vFp)
GO(jpeg_finish_decompress, iFp)
...
GO(jpeg_read_header, iFpi)
GO(jpeg_read_raw_data, uFppu)
GO(jpeg_read_scanlines, uFppu)
GO(jpeg_resync_to_restart, iFpi)
GO(jpeg_save_markers, vFpiu)
GO(jpeg_set_colorspace, vFpi)
GO(jpeg_set_defaults, vFp)
...
GO(jpeg_start_decompress, iFp)
GO(jpeg_start_output, iFpi)
GO(jpeg_std_error, pFp)
