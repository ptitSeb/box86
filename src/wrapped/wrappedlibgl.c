...
static void my_glDebugMessageCallback_##A(x86emu_t* emu, void* prod, void* param)   \
{                                                                                   \
...
static void my_glDebugMessageCallbackARB_##A(x86emu_t* emu, void* prod, void* param)   \
{                                                                                   \
...
static void my_glDebugMessageCallbackAMD_##A(x86emu_t* emu, void* prod, void* param)   \
{                                                                                   \
...
static void my_glDebugMessageCallbackKHR_##A(x86emu_t* emu, void* prod, void* param)   \
{                                                                                   \
...
static void my_glProgramCallbackMESA_##A(x86emu_t* emu, void* f, void* data)\
{                                                                           \
...
void* my_GetVkProcAddr(x86emu_t* emu, void* name, void*(*getaddr)(void*));  // defined in wrappedvulkan.c
// glGetVkProcAddrNV ...
#define GO(A)                                                           \
static pFp_t my_glGetVkProcAddrNV_fct_##A = NULL;                       \
static void* my_glGetVkProcAddrNV_##A(x86emu_t* emu, void* name)        \
{                                                                       \
...
#define PRE_INIT if(box86_libGL) {lib->w.lib = dlopen(box86_libGL, RTLD_LAZY | RTLD_GLOBAL); lib->path = strdup(box86_libGL);} else
#define CUSTOM_INIT \
    my_lib = lib;                                                               \
...
gl_wrappers_t* getGLProcWrapper(box86context_t* context, glprocaddress_t procaddress)
{
    int cnt, ret;
    khint_t k;
    if(!gl_wrappers) {
