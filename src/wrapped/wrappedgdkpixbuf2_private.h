...
//GO(gdk_pixbuf_get_bits_per_sample, 
//GO(gdk_pixbuf_get_byte_length, 
//GO(gdk_pixbuf_get_colorspace, 
//GO(gdk_pixbuf_get_file_info, 
//GO(gdk_pixbuf_get_formats, 
//GO(gdk_pixbuf_get_has_alpha, 
//GO(gdk_pixbuf_get_height, 
//GO(gdk_pixbuf_get_n_channels, 
//GO(gdk_pixbuf_get_option, 
//GO(gdk_pixbuf_get_pixels, 
//GO(gdk_pixbuf_get_pixels_with_length, 
//GO(gdk_pixbuf_get_rowstride, 
//GO(gdk_pixbuf_gettext, 
//GO(gdk_pixbuf_get_type, 
//GO(gdk_pixbuf_get_width, 
...
//GO(gdk_pixbuf_new_from_file, 
//GO(gdk_pixbuf_new_from_file_at_scale, 
//GO(gdk_pixbuf_new_from_file_at_size, 
//GO(gdk_pixbuf_new_from_inline, 
//GO(gdk_pixbuf_new_from_resource, 
//GO(gdk_pixbuf_new_from_resource_at_scale, 
//GO(gdk_pixbuf_new_from_stream, 
