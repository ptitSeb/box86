...
//GOM(new_fieldtype, pF@@)
GO(link_fieldtype, pFpp)
GO(free_fieldtype, iFp)
//GOM(set_fieldtype_arg, iFp@@@)
//GOM(set_fieldtype_choice, iFp@@)
...
GO(form_page, iFp)
GO(scale_form, iFppp)
//GOM(set_form_init, iFp@)
//GOM(set_form_term, iFp@)
//GOM(set_field_init, iFp@)
//GOM(set_field_term, iFp@)
GO(post_form, iFp)
GO(unpost_form, iFp)
