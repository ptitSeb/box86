...
//GO(snd_async_add_timer_handler, iFpp@p)
...
//GO(snd_async_add_ctl_handler, iFpp@p)
...
//GO(snd_hctl_elem_set_callback, vFp@)
...
//GO(snd_mixer_elem_set_callback, vFp@)
