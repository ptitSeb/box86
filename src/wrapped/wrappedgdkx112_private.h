...
GO(gdk_error_trap_pop, vFv)
GO(gdk_error_trap_push, iFv)
...
GO(gdk_image_unref, pFp)
GO(gdk_init, vFpp)
GO(gdk_init_check, iFpp)
...
GO(gdk_text_property_to_utf8_list, iFppipip)
