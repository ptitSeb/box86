...
static void* reverse_wire_to_eventFct(library_t* lib, void* fct)
{
    ...
    SUPER()
    #undef GO
    return (void*)AddBridge(lib->priv.w.bridge, lib->context, iFppp, fct, 0);
}
...
static void* reverse_error_handlerFct(library_t* lib, void* fct)
{
    ...
    SUPER()
    #undef GO
    return (void*)AddBridge(lib->priv.w.bridge, lib->context, iFpp, fct, 0);
}
...
static void* reverse_ioerror_handlerFct(library_t* lib, void* fct)
{
    ...
    SUPER()
    #undef GO
    return (void*)AddBridge(lib->priv.w.bridge, lib->context, iFp, fct, 0);
}
...
static void* reverse_exterror_handlerFct(library_t* lib, void* fct)
{
    ...
    SUPER()
    #undef GO
    return (void*)AddBridge(lib->priv.w.bridge, lib->context, iFpppp, fct, 0);
}
