...
//GO(GOACC_declare, 
//GO(GOACC_enter_data, 
//GO(GOACC_enter_exit_data, 
//GO(GOACC_exit_data, 
//GO(GOACC_get_num_threads, 
//GO(GOACC_get_thread_num, 
//GO(GOACC_parallel, 
//GO(GOACC_parallel_keyed, 
//GO(GOACC_update, 
//GO(GOACC_wait, 
//GO(GOMP_alloc, 
//GO(GOMP_atomic_end, 
...
//GO2(omp_destroy_lock@OMP_1.0, 
//GO(omp_destroy_lock, 
//GO(omp_destroy_lock_, 
//GO2(omp_destroy_lock_@OMP_1.0, 
//GO2(omp_destroy_nest_lock@OMP_1.0, 
//GO(omp_destroy_nest_lock, 
//GO(omp_destroy_nest_lock_, 
//GO2(omp_destroy_nest_lock_@OMP_1.0, 
...
//GO(omp_init_lock, 
//GO2(omp_init_lock@OMP_1.0, 
//GO(omp_init_lock_, 
//GO2(omp_init_lock_@OMP_1.0, 
//GO(omp_init_nest_lock, 
//GO2(omp_init_nest_lock@OMP_1.0, 
//GO(omp_init_nest_lock_, 
//GO2(omp_init_nest_lock_@OMP_1.0, 
//GO(omp_in_parallel, 
//GO(omp_in_parallel_, 
...
//GO(omp_set_lock, 
//GO2(omp_set_lock@OMP_1.0, 
//GO(omp_set_lock_, 
//GO2(omp_set_lock_@OMP_1.0, 
...
//GO2(omp_set_nest_lock@OMP_1.0, 
//GO(omp_set_nest_lock, 
//GO(omp_set_nest_lock_, 
//GO2(omp_set_nest_lock_@OMP_1.0, 
...
//GO2(omp_test_lock@OMP_1.0, 
//GO(omp_test_lock, 
//GO(omp_test_lock_, 
//GO2(omp_test_lock_@OMP_1.0, 
//GO2(omp_test_nest_lock@OMP_1.0, 
//GO(omp_test_nest_lock, 
//GO2(omp_test_nest_lock_@OMP_1.0, 
//GO(omp_test_nest_lock_, 
//GO(omp_unset_lock, 
//GO2(omp_unset_lock@OMP_1.0, 
//GO2(omp_unset_lock_@OMP_1.0, 
//GO(omp_unset_lock_, 
//GO(omp_unset_nest_lock, 
//GO2(omp_unset_nest_lock@OMP_1.0, 
//GO(omp_unset_nest_lock_, 
//GO2(omp_unset_nest_lock_@OMP_1.0, 
