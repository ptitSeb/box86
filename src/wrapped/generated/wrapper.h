...
void lFpd(x86emu_t *emu, uintptr_t fnc);
...
void UFppi(x86emu_t *emu, uintptr_t fnc);
void UFppu(x86emu_t *emu, uintptr_t fnc);
void UFVpV(x86emu_t *emu, uintptr_t fnc);
...
void lFplip(x86emu_t *emu, uintptr_t fnc);
...
void pFpVpppV(x86emu_t *emu, uintptr_t fnc);
...
void iFpllpppp(x86emu_t *emu, uintptr_t fnc);
...
void iFEv(x86emu_t *emu, uintptr_t fnc);
void pFEv(x86emu_t *emu, uintptr_t fnc);
void UFV0V(x86emu_t *emu, uintptr_t fnc);
...
void pFpV000V(x86emu_t *emu, uintptr_t fnc);
