...
void uFpCC(x86emu_t *emu, uintptr_t fnc);
...
void uFpCpu(x86emu_t *emu, uintptr_t fnc);
...
void uFpCpup(x86emu_t *emu, uintptr_t fnc);
...
void uFpppWW(x86emu_t *emu, uintptr_t fnc);
...
void uFpCppCC(x86emu_t *emu, uintptr_t fnc);
...
void pFpppppppppppppppp(x86emu_t *emu, uintptr_t fnc);
