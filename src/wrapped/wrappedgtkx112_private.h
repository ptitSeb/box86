...
GO(gtk_buildable_set_buildable_property, vFpppG)
...
GO(gtk_builder_value_from_string, iFpppGp)
GO(gtk_builder_value_from_string_type, iFpipGp)
...
GO(gtk_rc_property_parse_border, iFppG)
GO(gtk_rc_property_parse_color, iFppG)
GO(gtk_rc_property_parse_enum, iFppG)
GO(gtk_rc_property_parse_flags, iFppG)
GO(gtk_rc_property_parse_requisition, iFppG)
...
GO(gtk_style_get_style_property, vFpipG)
...
GO(gtk_tree_model_get_value, vFppiG)
...
GO(gtk_tree_store_set_value, vFppiG)
...
GO(gtk_widget_style_get_property, vFppG)
