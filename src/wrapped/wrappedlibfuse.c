...
typedef struct x86_entry_param_s {
        unsigned long ino;
        unsigned long generation;
        struct i386_stat64 attr;
        double attr_timeout;
        double entry_timeout;
} x86_entry_param_t;
...
EXPORT int my_fuse_opt_parse(x86emu_t* emu, void* args, void* data, void* opts, void* f)
{
    return my->fuse_opt_parse(args, data, opts, findfuse_opt_procFct(f));
}

EXPORT void* my_fuse_lowlevel_new(x86emu_t* emu, void* args, fuse_lowlevel_ops_t *o, size_t sz, void* data)
{
...
EXPORT int my_fuse_reply_entry(x86emu_t* emu, void* req, const x86_entry_param_t *e)
{
...
EXPORT int my_fuse_reply_create(x86emu_t* emu, void* req, const x86_entry_param_t *e, void* fi)
{
    static fuse_entry_param_t e_;
    if(e) {
        e_.ino = e->ino;
...
EXPORT int my_fuse_reply_attr(x86emu_t* emu, void* req, const struct i386_stat64 *attr, double attr_timeout)
{
...
EXPORT size_t my_fuse_add_direntry(x86emu_t* emu, void* req, char *buf, size_t bufsize, void* name, const struct i386_stat64 *stbuf, off_t off)
{
...
EXPORT int my_fuse_main_real(x86emu_t* emu, int argc, void* argv, const fuse_operations_t* op, size_t op_size, void* data)
{
