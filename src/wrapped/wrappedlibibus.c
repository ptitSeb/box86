...
EXPORT void my_ibus_bus_create_input_context_async(x86emu_t* emu, void* bus, void* name, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_create_input_context_async(bus, name, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_bus_current_input_context_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_current_input_context_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_bus_get_global_engine_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_get_global_engine_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_bus_list_active_engines_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_list_active_engines_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_bus_list_engines_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_list_engines_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_bus_set_global_engine_async(x86emu_t* emu, void* bus, void* engine, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_set_global_engine_async(bus, engine, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_config_get_value_async(x86emu_t* emu, void* bus, void* section, void* name, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_config_get_value_async(bus, section, name, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_config_get_values_async(x86emu_t* emu, void* bus, void* section, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_config_get_values_async(bus, section, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_config_set_value_async(x86emu_t* emu, void* bus, void* section, void* name, void* value, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_config_set_value_async(bus, section, name, value, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_input_context_get_engine_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_input_context_get_engine_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

EXPORT void my_ibus_input_context_process_key_event_async(x86emu_t* emu, void* bus, uint32_t keyval, uint32_t keycode, uint32_t state, int timeout, void* cancel, void* f, void* data)
{
