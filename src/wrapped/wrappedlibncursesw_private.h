...
GO(set_term, pFp)
GO(slk_attroff, iFi)
GO(slk_attr_off, iFip)
GO(slk_attron, iFi)
GO(slk_attr_on, iFip)
GO(slk_attrset, iFi)
GO(slk_attr, iFv)
GO(slk_attr_set, iFiwp)
GO(slk_clear, iFv)
GO(slk_color, iFw)
GO(slk_init, iFi)
GO(slk_label, pFi)
