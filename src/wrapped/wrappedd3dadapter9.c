...
static int my_CreateAuthenticatedChannel(x86emu_t* emu, void* This, int ChannelType, void*** ppAuthenticatedChannel, void* pChannelHandle);
...
static int my_CreateCryptoSession(x86emu_t* emu, void* This, const void* pCryptoType, const void* pDecodeProfile, void*** ppCryptoSession, void* pCryptoHandle);
...
static int my_CreateCubeTexture(x86emu_t* emu, void* This, unsigned EdgeLength, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppCubeTexture, void* pSharedHandle);
...
static int my_CreateIndexBuffer(x86emu_t* emu, void* This, unsigned Length, unsigned Usage, int Format, int Pool, void*** ppIndexBuffer, void* pSharedHandle);
static int (*my_CreatePixelShader_real)(void* This, const void* pFunction, void*** ppShader);
static int my_CreatePixelShader(x86emu_t* emu, void* This, const void* pFunction, void*** ppShader);
static int (*my_CreateQuery_real)(void* This, int Type, void*** ppQuery);
static int my_CreateQuery(x86emu_t* emu, void* This, int Type, void*** ppQuery);
static int (*my_CheckResourceResidency_real)(void* This, void*** pResourceArray, unsigned NumResources);
static int my_CheckResourceResidency(x86emu_t* emu, void* This, void*** pResourceArray, unsigned NumResources);
static int (*my_CreateStateBlock_real)(void* This, int Type, void*** ppSB);
static int my_CreateStateBlock(x86emu_t* emu, void* This, int Type, void*** ppSB);
static int (*my_EndStateBlock_real)(void* This, void*** ppSB);
static int my_EndStateBlock(x86emu_t* emu, void* This, void*** ppSB);
...
static int my_CreateDepthStencilSurfaceEx(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Discard, void*** ppSurface, void* pSharedHandle, unsigned Usage);
...
static int my_CreateDepthStencilSurface(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Discard, void*** ppSurface, void* pSharedHandle);
...
static int my_CreateOffscreenPlainSurfaceEx(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int Pool, void*** ppSurface, void* pSharedHandle, unsigned Usage);
...
static int my_CreateOffscreenPlainSurface(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int Pool, void*** ppSurface, void* pSharedHandle);
...
static int my_CreateRenderTargetEx(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Lockable, void*** ppSurface, void* pSharedHandle, unsigned Usage);
...
static int my_CreateRenderTarget(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Lockable, void*** ppSurface, void* pSharedHandle);
static int (*my_GetCubeMapSurface_real)(void* This, int FaceType, unsigned Level, void*** ppCubeMapSurface);
static int my_GetCubeMapSurface(x86emu_t* emu, void* This, int FaceType, unsigned Level, void*** ppCubeMapSurface);
static int (*my_GetDepthStencilSurface_real)(void* This, void*** ppZStencilSurface);
static int my_GetDepthStencilSurface(x86emu_t* emu, void* This, void*** ppZStencilSurface);
static int (*my_GetBackBuffer_real)(void* This, unsigned iSwapChain, unsigned iBackBuffer, int Type, void*** ppBackBuffer);
static int my_GetBackBuffer(x86emu_t* emu, void* This, unsigned iSwapChain, unsigned iBackBuffer, int Type, void*** ppBackBuffer);
static int (*my_GetRenderTarget_real)(void* This, unsigned RenderTargetIndex, void*** ppRenderTarget);
static int my_GetRenderTarget(x86emu_t* emu, void* This, unsigned RenderTargetIndex, void*** ppRenderTarget);
static int (*my_GetSurfaceLevel_real)(void* This, unsigned Level, void*** ppSurfaceLevel);
static int my_GetSurfaceLevel(x86emu_t* emu, void* This, unsigned Level, void*** ppSurfaceLevel);
static int (*my_CreateAdditionalSwapChain_real)(void* This, void* pPresentationParameters, void*** pSwapChain);
static int my_CreateAdditionalSwapChain(x86emu_t* emu, void* This, void* pPresentationParameters, void*** pSwapChain);
static int (*my_GetSwapChain_real)(void* This, unsigned iSwapChain, void*** pSwapChain);
static int my_GetSwapChain(x86emu_t* emu, void* This, unsigned iSwapChain, void*** pSwapChain);
...
static int my_CreateTexture(x86emu_t* emu, void* This, unsigned Width, unsigned Height, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppTexture, void* pSharedHandle);
...
static int my_CreateVertexBuffer(x86emu_t* emu, void* This, unsigned Length, unsigned Usage, unsigned FVF, int Pool, void*** ppVertexBuffer, void* pSharedHandle);
static int (*my_CreateVertexDeclaration_real)(void* This, const void* pVertexElements, void*** ppDecl);
static int my_CreateVertexDeclaration(x86emu_t* emu, void* This, const void* pVertexElements, void*** ppDecl);
static int (*my_CreateVertexShader_real)(void* This, const void* pFunction, void*** ppShader);
static int my_CreateVertexShader(x86emu_t* emu, void* This, const void* pFunction, void*** ppShader);
static int (*my_GetVolumeLevel_real)(void* This, unsigned Level, void*** ppVolumeLevel);
static int my_GetVolumeLevel(x86emu_t* emu, void* This, unsigned Level, void*** ppVolumeLevel);
...
#define GO(name, type, size) \
    new->name = (void*)AddBridge(emu->context->system, emu->context, type, real->name, size*4)

#define GOM(name, type, size) \
    my_##name##_real = (void*)real->name; \
    new->name = (void*)AddBridge(emu->context->system, emu->context, type, my_##name, size*4)

#define GO2(name, type, size) \
    my_##name##_real2 = (void*)real->name; \
    new->name = (void*)AddBridge(emu->context->system, emu->context, type, my_##name2, size*4)
...
GO(my_CreateAuthenticatedChannel, (x86emu_t* emu, void* This, int ChannelType, void*** ppAuthenticatedChannel, void* pChannelHandle), (This, ChannelType, ppAuthenticatedChannel, pChannelHandle), int, IDirect3DAuthenticatedChannel9Vtbl, ppAuthenticatedChannel)
GO(my_CreateCryptoSession, (x86emu_t* emu, void* This, const void* pCryptoType, const void* pDecodeProfile, void*** ppCryptoSession, void* pCryptoHandle), (This, pCryptoType, pDecodeProfile, ppCryptoSession, pCryptoHandle), int, IDirect3DCryptoSession9Vtbl, ppCryptoSession)
GO(my_CreateCubeTexture, (x86emu_t* emu, void* This, unsigned EdgeLength, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppCubeTexture, void* pSharedHandle), (This, EdgeLength, Levels, Usage, Format, Pool, ppCubeTexture, pSharedHandle), int, IDirect3DCubeTexture9Vtbl, ppCubeTexture)
GO(my_CreateIndexBuffer, (x86emu_t* emu, void* This, unsigned Length, unsigned Usage, int Format, int Pool, void*** ppIndexBuffer, void* pSharedHandle), (This, Length, Usage, Format, Pool, ppIndexBuffer, pSharedHandle), int, IDirect3DIndexBuffer9Vtbl, ppIndexBuffer)
GO(my_CreatePixelShader, (x86emu_t* emu, void* This, const void* pFunction, void*** ppShader), (This, pFunction, ppShader), int, IDirect3DPixelShader9Vtbl, ppShader)
GO(my_CheckResourceResidency, (x86emu_t* emu, void* This, void*** pResourceArray, unsigned NumResources), (This, pResourceArray, NumResources), int, IDirect3DResource9Vtbl, pResourceArray)
GO(my_CreateStateBlock, (x86emu_t* emu, void* This, int Type, void*** ppSB), (This, Type, ppSB), int, IDirect3DStateBlock9Vtbl, ppSB)
GO(my_EndStateBlock, (x86emu_t* emu, void* This, void*** ppSB), (This, ppSB), int, IDirect3DStateBlock9Vtbl, ppSB)
GO(my_CreateDepthStencilSurfaceEx, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Discard, void*** ppSurface, void* pSharedHandle, unsigned Usage), (This, Width, Height, Format, MultiSample, MultisampleQuality, Discard, ppSurface, pSharedHandle, Usage), int, IDirect3DSurface9Vtbl, ppSurface)
GO(my_CreateDepthStencilSurface, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Discard, void*** ppSurface, void* pSharedHandle), (This, Width, Height, Format, MultiSample, MultisampleQuality, Discard, ppSurface, pSharedHandle), int, IDirect3DSurface9Vtbl, ppSurface)
GO(my_CreateOffscreenPlainSurfaceEx, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int Pool, void*** ppSurface, void* pSharedHandle, unsigned Usage), (This, Width, Height, Format, Pool, ppSurface, pSharedHandle, Usage), int, IDirect3DSurface9Vtbl, ppSurface)
GO(my_CreateOffscreenPlainSurface, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int Pool, void*** ppSurface, void* pSharedHandle), (This, Width, Height, Format, Pool, ppSurface, pSharedHandle), int, IDirect3DSurface9Vtbl, ppSurface)
GO(my_CreateRenderTargetEx, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Lockable, void*** ppSurface, void* pSharedHandle, unsigned Usage), (This, Width, Height, Format, MultiSample, MultisampleQuality, Lockable, ppSurface, pSharedHandle, Usage), int, IDirect3DSurface9Vtbl, ppSurface)
GO(my_CreateRenderTarget, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Lockable, void*** ppSurface, void* pSharedHandle), (This, Width, Height, Format, MultiSample, MultisampleQuality, Lockable, ppSurface, pSharedHandle), int, IDirect3DSurface9Vtbl, ppSurface)
GO(my_GetCubeMapSurface, (x86emu_t* emu, void* This, int FaceType, unsigned Level, void*** ppCubeMapSurface), (This, FaceType, Level, ppCubeMapSurface), int, IDirect3DSurface9Vtbl, ppCubeMapSurface)
GO(my_GetDepthStencilSurface, (x86emu_t* emu, void* This, void*** ppZStencilSurface), (This, ppZStencilSurface), int, IDirect3DSurface9Vtbl, ppZStencilSurface)
GO(my_GetBackBuffer, (x86emu_t* emu, void* This, unsigned iSwapChain, unsigned iBackBuffer, int Type, void*** ppBackBuffer), (This, iSwapChain, iBackBuffer, Type, ppBackBuffer), int, IDirect3DSurface9Vtbl, ppBackBuffer)
GO(my_GetRenderTarget, (x86emu_t* emu, void* This, unsigned RenderTargetIndex, void*** ppRenderTarget), (This, RenderTargetIndex, ppRenderTarget), int, IDirect3DSurface9Vtbl, ppRenderTarget)
GO(my_GetSurfaceLevel, (x86emu_t* emu, void* This, unsigned Level, void*** ppSurfaceLevel), (This, Level, ppSurfaceLevel), int, IDirect3DSurface9Vtbl, ppSurfaceLevel)
GO(my_CreateAdditionalSwapChain, (x86emu_t* emu, void* This, void* pPresentationParameters, void*** pSwapChain), (This, pPresentationParameters, pSwapChain), int, IDirect3DSwapChain9Vtbl, pSwapChain)
GO(my_GetSwapChain, (x86emu_t* emu, void* This, unsigned iSwapChain, void*** pSwapChain), (This, iSwapChain, pSwapChain), int, IDirect3DSwapChain9Vtbl, pSwapChain)
GO(my_CreateTexture, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppTexture, void* pSharedHandle), (This, Width, Height, Levels, Usage, Format, Pool, ppTexture, pSharedHandle), int, IDirect3DTexture9Vtbl, ppTexture)
GO(my_CreateVertexBuffer, (x86emu_t* emu, void* This, unsigned Length, unsigned Usage, unsigned FVF, int Pool, void*** ppVertexBuffer, void* pSharedHandle), (This, Length, Usage, FVF, Pool, ppVertexBuffer, pSharedHandle), int, IDirect3DVertexBuffer9Vtbl, ppVertexBuffer)
GO(my_CreateVertexDeclaration, (x86emu_t* emu, void* This, const void* pVertexElements, void*** ppDecl), (This, pVertexElements, ppDecl), int, IDirect3DVertexDeclaration9Vtbl, ppDecl)
GO(my_CreateVertexShader, (x86emu_t* emu, void* This, const void* pFunction, void*** ppShader), (This, pFunction, ppShader), int, IDirect3DVertexShader9Vtbl, ppShader)
GO(my_GetVolumeLevel, (x86emu_t* emu, void* This, unsigned Level, void*** ppVolumeLevel), (This, Level, ppVolumeLevel), int, IDirect3DVolume9Vtbl, ppVolumeLevel)
GO(my_CreateVolumeTexture, (x86emu_t* emu, void* This, unsigned Width, unsigned Height, unsigned Depth, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppVolumeTexture, void* pSharedHandle), (This, Width, Height, Depth, Levels, Usage, Format, Pool, ppVolumeTexture, pSharedHandle), int, IDirect3DVolumeTexture9Vtbl, ppVolumeTexture)

GOR((r || !ppQuery), my_CreateQuery, (x86emu_t* emu, void* This, int Type, void*** ppQuery), (This, Type, ppQuery), int, IDirect3DQuery9Vtbl, ppQuery)
...
EXPORT void* my_D3DAdapter9GetProc(x86emu_t* emu, void *ptr)
{
    ...
    *(uint32_t *)(R_ESP + 4) = *(uint32_t *)(R_ESP);
    ...
    my->adapter.create_adapter = (void*)AddBridge(emu->context->system, emu->context, iFEip, my_create_adapter, 8);
